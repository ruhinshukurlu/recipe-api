...
class PublicIngredientApiTests(TestCase):
    ...
    def test_auth_required(self):
        """Test auth is reqired to retrieve the ingredients"""
...
class PrivateIngredientApiTests(TestCase):
    ...
    def test_update_ingredient(self):
        ...
        payload = {'name': 'Ingredient1 update'}
    ...
    def test_delete_ingredient(self):
        ...
        ingredient = Ingredient.objects.create(user=self.user, name='Ingredient sample')
        url = detail_url(ingredient.id)
    ...
    def test_filter_ingredients_assigned_to_recipes(self):
        ...
        recipe = Recipe.objects.create(user=self.user, title='Recipe title', time_minutes=4, price=Decimal('2.50'))
    ...
    def test_filtered_ingredients_unique(self):
        ...
        recipe1 = Recipe.objects.create(user=self.user, title='Recipe 1 title', time_minutes=4, price=Decimal('2.50'))
        recipe2 = Recipe.objects.create(user=self.user, title='Recipe 2 title', time_minutes=20, price=Decimal('4.50'))
