...
def create_recipe(user, **params):
    ...
    defaults = {
        ...
        'time_minutes':22,
        'price':Decimal('5.50'),
        'description':'Some description for the recipe',
        'link':'some link',
    }
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_retrieve_recipes(self):
        """Test retrieve list of the Recipes."""
    ...
    def test_recipe_list_limited_to_user(self):
        """Test list of the recipes is limited to authenticated user."""
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user=self.user, title='Recipe 1 sample title')
        r2 = create_recipe(user=self.user, title='Recipe 2 sample title')
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Recipe1 title')
